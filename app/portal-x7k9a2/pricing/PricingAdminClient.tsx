  ...
  return (
    <main className="min-h-screen bg-[radial-gradient(circle_at_top,rgba(255,106,0,0.14),transparent_28%),linear-gradient(180deg,#050816_0%,#0B1220_55%,#050816_100%)] px-6 py-10 pt-28 text-white">
      <div className="mx-auto max-w-5xl">
        ...
        {loading && (
          <div className="rounded-[32px] border border-white/10 bg-white/[0.04] p-6 text-slate-300 backdrop-blur">
            Loading pricing settings...
          </div>
        )}

        {error && (
          <div className="rounded-[32px] border border-red-500/30 bg-red-500/10 p-6 text-red-200">
            {error}
          </div>
        )}
